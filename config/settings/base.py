"""
Django settings for Baller Search project.
...
ROOT_DIR = environ.Path(__file__) - 3  # (baller_search/config/settings/base.py - 3 = baller_search/)
APPS_DIR = ROOT_DIR.path('baller_search')
